...
<div class="col-md-6 mt-5 m-auto bg-white shadow font-monospace border border-info">
    ...
    <div class="mb-3">
        <button  class="w-100 bg-warning fs-4 text-white border-0">LOGIN</button>

    <div class="mb-3">
        <a href="register.php" class="w-100 d-block bg-danger fs-4 text-white text-center text-decoration-none py-2">REGISTER</a>
    </div>
</form>
